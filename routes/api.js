...
// subir y modificar imagenes al Cloudinary y reflejarlas en web
...
// recibir info del formulario al mail
router.post('/contacto', async (req, res) => {
    const mail = {
        to: 'bruno_freijomil@hotmail.com',
        subject: 'Contacto web Escuela de Manejo',
